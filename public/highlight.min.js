...
},S=M("//","$"),C=M("/\\*","\\*/"),A=M("#","$");var T=Object.freeze({
__proto__:null,MATCH_NOTHING_RE:/\b\B/,IDENT_RE:E,UNDERSCORE_IDENT_RE:y,
NUMBER_RE:v,C_NUMBER_RE:w,BINARY_NUMBER_RE:N,
RE_STARTERS_RE:"!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",
SHEBANG:(e={})=>{const n=/^#![ ]*\//
...
},COMMENT:M,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:C,HASH_COMMENT_MODE:A,
NUMBER_MODE:{scope:"number",begin:v,relevance:0},C_NUMBER_MODE:{scope:"number",
...
Object.assign(a,U(e[t],n,t))})),a;function r(e,t){
n&&(t=t.map((e=>e.toLowerCase()))),t.forEach((n=>{const t=n.split("|")
;a[t[0]]=[e,P(t[0],t[1])]}))}}function P(e,n){
return n?Number(n):(e=>j.includes(e.toLowerCase()))(e)?0:1}const K={},q=e=>{
console.error(e)},F=(e,...n)=>{console.log("WARN: "+e,...n)},H=(e,n)=>{
K[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),K[`${e}/${n}`]=!0)
},G=Error();function Z(e,n,{key:t}){let a=0;const r=e[t],i={},s={}
;for(let e=1;e<=n.length;e++)s[e+a]=r[e],i[e+a]=!0,a+=_(n[e-1])
...
;[D,L,W,z].forEach((e=>e(i,s))),e.compilerExtensions.forEach((e=>e(i,s))),
i.__beforeBegin=null,[I,B,$].forEach((e=>e(i,s))),i.isCompiled=!0;let c=null
...
const V=a,Y=r,ee=Symbol("nomatch"),ne=n=>{
...
;"object"==typeof n?(a=e,
t=n.ignoreIllegals,r=n.language):(H("10.7.0","highlight(lang, code, ...args) has been deprecated."),
H("10.7.0","Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"),
r=e,a=n),void 0===t&&(t=!0);const i={code:a,language:r};O("before:highlight",i)
;const s=i.result?i.result:f(i.language,i.code,t)
;return s.code=i.code,O("after:highlight",s),s}function f(e,n,r,i){
...
;const r=v.case_insensitive?n[0].toLowerCase():n[0],i=(a=r,x.keywords[a]);if(i){
const[e,a]=i
;if(M.addText(t),t="",c[r]=(c[r]||0)+1,c[r]<=7&&(C+=a),e.startsWith("_"))t+=n[0];else{
const t=v.classNameAliases[e]||e;M.addKeyword(n[0],t)}}else t+=n[0]
...
;x.relevance>0&&(C+=e.relevance),M.addSublanguage(e._emitter,e.language)
})():l(),S=""}function u(e,n){let t=1;const a=n.length-1;for(;t<=a;){
if(!e._emit[t]){t++;continue}const a=v.classNameAliases[e[t]]||e[t],r=n[t]
;a?M.addKeyword(r,a):(S=r,l(),S=""),t++}}function b(e,n){
return e.scope&&"string"==typeof e.scope&&M.openNode(v.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(M.addKeyword(S,v.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
S=""):e.beginScope._multi&&(u(e.beginScope,n),S="")),x=Object.create(e,{parent:{
value:x}}),x}function m(e,n,a){let r=((e,n)=>{const t=e&&e.exec(n)
...
const t=e[0],a=n.substring(e.index),r=m(x,e,a);if(!r)return ee;const i=x
;x.endScope&&x.endScope._wrap?(g(),
M.addKeyword(t,x.endScope._wrap)):x.endScope&&x.endScope._multi?(g(),
u(x.endScope,e)):i.skip?S+=t:(i.returnEnd||i.excludeEnd||(S+=t),
g(),i.excludeEnd&&(S=t));do{
x.scope&&M.closeNode(),x.skip||x.subLanguage||(C+=x.relevance),x=x.parent
}while(x!==r.parent);return r.starts&&b(r.starts,e),i.returnEnd?0:t.length}
let h={};function y(a,i){const o=i&&i[0];if(S+=a,null==o)return g(),0
;if("begin"===h.type&&"end"===i.type&&h.index===i.index&&""===o){
if(S+=n.slice(i.index,i.index+1),!s){const n=Error(`0 width match regex (${e})`)
;throw n.languageName=e,n.badRule=h.rule,n}return 1}
if(h=i,"begin"===i.type)return(e=>{
const n=e[0],a=e.rule,r=new t(a),i=[a.__beforeBegin,a["on:begin"]]
;for(const t of i)if(t&&(t(e,r),r.isMatchIgnored))return p(n)
;return a.skip?S+=n:(a.excludeBegin&&(S+=n),
g(),a.returnBegin||a.excludeBegin||(S=n)),b(a,e),a.returnBegin?0:n.length})(i)
;if("illegal"===i.type&&!r){
const e=Error('Illegal lexeme "'+o+'" for mode "'+(x.scope||"<unnamed>")+'"')
;throw e.mode=x,e}if("end"===i.type){const e=_(i);if(e!==ee)return e}
...
;const w=Q(v);let k="",x=i||w;const O={},M=new d.__emitter(d);(()=>{const e=[]
;for(let n=x;n!==v;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>M.openNode(e)))})();let S="",C=0,A=0,T=0,R=!1;try{
for(x.matcher.considerAll();;){
T++,R?R=!1:x.matcher.considerAll(),x.matcher.lastIndex=A
;const e=x.matcher.exec(n);if(!e)break;const t=y(n.substring(A,e.index),e)
;A=e.index+t}
return y(n.substring(A)),M.closeAllNodes(),M.finalize(),k=M.toHTML(),{
language:e,value:k,relevance:C,illegal:!1,_emitter:M,_top:x}}catch(t){
if(t.message&&t.message.includes("Illegal"))return{language:e,value:V(n),
illegal:!0,relevance:0,_illegalBy:{message:t.message,index:A,
context:n.slice(A-100,A+100),mode:t.mode,resultSoFar:k},_emitter:M};if(s)return{
language:e,value:V(n),illegal:!1,relevance:0,errorRaised:t,_emitter:M,_top:x}
...
;return n._emitter.addText(e),n})(e),r=n.filter(N).filter(x).map((n=>f(n,e,!1)))
;r.unshift(t);const i=r.sort(((e,n)=>{
if(e.relevance!==n.relevance)return n.relevance-e.relevance
;if(e.language&&n.language){if(N(e.language).supersetOf===n.language)return 1
;if(N(n.language).supersetOf===e.language)return-1}return 0})),[s,o]=i,l=s
...
console.warn(e)),d.throwUnescapedHTML))throw new J("One of your code blocks includes unescaped HTML.",e.innerHTML)
;n=e;const a=n.textContent,i=t?h(a,{language:t,ignoreIllegals:!0}):E(a)
...
}),O("after:highlightElement",{el:e,result:i,text:a})}let v=!1;function w(){
"loading"!==document.readyState?document.querySelectorAll(d.cssSelector).forEach(y):v=!0
}function N(e){return e=(e||"").toLowerCase(),a[e]||a[r[e]]}
function k(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{
r[e.toLowerCase()]=n}))}function x(e){const n=N(e)
;return n&&!n.disableAutodetect}function O(e,n){const t=e;i.forEach((e=>{
e[t]&&e[t](n)}))}
"undefined"!=typeof window&&window.addEventListener&&window.addEventListener("DOMContentLoaded",(()=>{
v&&w()}),!1),Object.assign(n,{highlight:h,highlightAuto:E,highlightAll:w,
highlightElement:y,
...
!s)throw n;q(n),r=c}
r.name||(r.name=e),a[e]=r,r.rawDefinition=t.bind(null,n),r.aliases&&k(r.aliases,{
...
removePlugin:e=>{const n=i.indexOf(e);-1!==n&&i.splice(n,1)}}),n.debugMode=()=>{
...
;return Object.assign(n,T),n},te=ne({});te.newInstance=()=>ne({})
...
;var ce="\\.([0-9](_*[0-9])*)",le="[0-9a-fA-F](_*[0-9a-fA-F])*",de={
...
relevance:0}
;const ge="[A-Za-z$_][0-9A-Za-z$_]*",ue=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],be=["true","false","null","undefined","NaN","Infinity"],me=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],pe=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],_e=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],he=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],fe=[].concat(_e,me,pe)
;function Ee(e){const n=e.regex,t=ge,a={begin:/<[A-Za-z0-9\\._:-]+/,
...
}},r={$pattern:ge,keyword:ue,literal:be,built_in:fe,"variable.language":he
...
end:"\\}",keywords:r,contains:[]},l={begin:"html`",end:"",starts:{end:"`",
returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,c],subLanguage:"xml"}},d={
begin:"css`",end:"",starts:{end:"`",returnEnd:!1,
contains:[e.BACKSLASH_ESCAPE,c],subLanguage:"css"}},g={begin:"gql`",end:"",
starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,c],
subLanguage:"graphql"}},u={className:"string",begin:"`",end:"`",
contains:[e.BACKSLASH_ESCAPE,c]},b={className:"comment",
...
},m=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,l,d,g,u,{match:/\$\d+/},o]
;c.contains=m.concat({begin:/\{/,end:/\}/,keywords:r,contains:["self"].concat(m)
});const p=[].concat(b,c.contains),_=p.concat([{begin:/\(/,end:/\)/,keywords:r,
contains:["self"].concat(p)}]),h={className:"params",begin:/\(/,end:/\)/,
excludeBegin:!0,excludeEnd:!0,keywords:r,contains:_},f={variants:[{
match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,n.concat(t,"(",n.concat(/\./,t),")*")],
scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{
match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},E={relevance:0,
match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),
className:"title.class",keywords:{_:[...me,...pe]}},y={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[h],
illegal:/%/},v={
match:n.concat(/\b/,(w=[..._e,"super","import"],n.concat("(?!",w.join("|"),")")),t,n.lookahead(/\(/)),
...
},e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,l,d,g,u,b,{match:/\$\d+/},o,E,{
...
className:"variable.constant"},f,k,{match:/\$[(.]/}]}}function ye(e,n,t){
return-1===t?"":e.replace(n,(a=>ye(e,n,t-1)))}function ve(e,n={}){
return n.variants=e,n}var we=Object.freeze({__proto__:null,grmr_python:e=>{
...
end:/\}/,keywords:r,illegal:/#/},o={begin:/\{\{/,relevance:0},c={
...
}]},b={className:"comment",begin:n.lookahead(/# type:/),end:/$/,keywords:r,
contains:[{begin:/# type:/},{begin:/#/,end:/\b\B/,endsWithParent:!0}]},m={
className:"params",variants:[{className:"",begin:/\(\s*\)/,skip:!0},{begin:/\(/,
end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:r,
contains:["self",i,u,c,e.HASH_COMMENT_MODE]}]};return s.contains=[c,u,i],{
...
keywords:i}]},m=[d,{variants:[{match:[/class\s+/,r,/\s+<\s+/,r]},{
...
starts:{end:"$",keywords:i,contains:m}}];return c.unshift(o),{name:"Ruby",
...
},contains:[c,e.SHEBANG(),l,o,e.HASH_COMMENT_MODE,i,{match:/(\/[a-z._-]+)+/},s,{
className:"",begin:/\\"/},{className:"string",begin:/'/,end:/'/},t]}},
grmr_css:e=>{const n=e.regex,t=(e=>({IMPORTANT:{scope:"meta",begin:"!important"
...
className:"selector-tag",begin:"\\b("+ae.join("|")+")\\b"}]}},grmr_xml:e=>{
...
},c=de,l=e.COMMENT("/\\*","\\*/",{contains:[e.C_BLOCK_COMMENT_MODE]}),d={
...
},e.C_LINE_COMMENT_MODE,l,s,o,i,e.C_NUMBER_MODE]},l]},{
...
end:"$",illegal:"\n"},c]}},grmr_markdown:e=>{const n={begin:/<\/?[A-Za-z_]/,
end:">",subLanguage:"xml",relevance:0},t={variants:[{begin:/\[.+?\]\[.*?\]/,
relevance:0},{
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}},grmr_sql:e=>{
...
})(c,{when:e=>e.length<3}),literal:a,type:r,
built_in:["current_catalog","current_date","current_default_transform_group","current_path","current_role","current_schema","current_transform_group_for_type","current_user","session_user","system_time","system_user","current_time","localtime","current_timestamp","localtimestamp"]
},contains:[{begin:n.either(...s),relevance:0,keywords:{$pattern:/[\w\.]+/,
keyword:c.concat(s),literal:a,type:r}},{className:"type",
...
contains:[n.exports.CLASS_REFERENCE]},i={$pattern:ge,
keyword:ue.concat(["type","namespace","interface","public","private","protected","implements","declare","abstract","readonly","enum","override"]),
literal:be,built_in:fe.concat(t),"variable.language":he},s={className:"meta",
...
name:"TypeScript",aliases:["ts","tsx","mts","cts"]}),n},grmr_c:e=>{
...
},u=[c,i,t,e.C_BLOCK_COMMENT_MODE,o,s],b={variants:[{begin:/=/,end:/;/},{
...
disableAutodetect:!0,illegal:"</",contains:[].concat(b,m,u,[c,{
...
end:/$/}]}},grmr_json:e=>{const n=["true","false","null"],t={scope:"literal",
...
subLanguage:"bash"}}]}),grmr_csharp:e=>{const n={
...
;s.contains=[l,c,r,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,a,e.C_BLOCK_COMMENT_MODE],
o.contains=[d,c,i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,a,e.inherit(e.C_BLOCK_COMMENT_MODE,{
illegal:/\n/})];const g={variants:[l,c,r,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE]
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},m]}},grmr_go:e=>{const n={
...
begin:/\(/,end:/\)/,endsParent:!0,keywords:n,illegal:/["']/}]}]}},grmr_java:e=>{
...
contains:[i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,de,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},de,i]}},grmr_lua:e=>{
...
begin:n,end:t,contains:[a],relevance:5}])}},grmr_php:e=>{
...
match:[/new/,n.concat(c,"+"),n.concat("(?!",p(b).join("\\b|"),"\\b)"),r],scope:{
...
begin:/\(/,end:/\)/,keywords:m,contains:[E,i,f,e.C_BLOCK_COMMENT_MODE,l,d,_]
},v={relevance:0,
match:[/\b/,n.concat("(?!fn\\b|function\\b|",p(u).join("\\b|"),"|",p(b).join("\\b|"),"\\b)"),a,n.concat(c,"*"),n.lookahead(/(?=\()/)],
scope:{3:"title.function.invoke"},contains:[y]};y.contains.push(v)
;const w=[E,f,e.C_BLOCK_COMMENT_MODE,l,d,_];return{case_insensitive:!1,
keywords:m,contains:[{begin:n.concat(/#\[\s*/,r),beginScope:"meta",end:/]/,
...
begin:/\?>/}]},{scope:"variable.language",match:/\$this\b/},i,v,f,{
match:[/const/,/\s/,a],scope:{1:"keyword",3:"variable.constant"}},_,{
scope:"function",relevance:0,beginKeywords:"fn function",end:/[;{]/,
excludeEnd:!0,illegal:"[$%\\[]",contains:[{beginKeywords:"use"
},e.UNDERSCORE_TITLE_MODE,{begin:"=>",endsParent:!0},{scope:"params",
begin:"\\(",end:"\\)",excludeBegin:!0,excludeEnd:!0,keywords:m,
contains:["self",i,f,e.C_BLOCK_COMMENT_MODE,l,d]}]},{scope:"class",variants:[{
...
},grmr_rust:e=>{const n=e.regex,t={className:"title.function.invoke",
relevance:0,begin:n.concat(/\b/,/(?!let\b)/,e.IDENT_RE,n.lookahead(/\s*\(/))
...
grmr_cpp:e=>{const n=e.regex,t=e.COMMENT("//","$",{contains:[{begin:/\\\n/}]
...
},b=[u,c,i,t,e.C_BLOCK_COMMENT_MODE,o,s],m={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
...
},i,t,e.C_BLOCK_COMMENT_MODE,c]};return{name:"C++",
...
className:{1:"keyword",3:"title.class"}}])}},grmr_javascript:Ee,grmr_cmake:e=>({
...
},{className:"number",begin:e.C_NUMBER_RE+"\\b",relevance:0},s,o,a],l=[...c]
;return l.pop(),l.push(r),i.contains=l,{name:"YAML",case_insensitive:!0,
aliases:["yml"],contains:c}},grmr_ini:e=>{const n=e.regex,t={className:"number",
relevance:0,variants:[{begin:/([+-]+)?[\d]+_[\d_]+/},{begin:e.NUMBER_RE}]
},a=e.COMMENT();a.variants=[{begin:/;/,end:/$/},{begin:/#/,end:/$/}];const r={
className:"variable",variants:[{begin:/\$[\w\d"][\w\d_]*/},{begin:/\$\{(.*?)\}/
}]},i={className:"literal",begin:/\bon|off|true|false|yes|no\b/},s={
className:"string",contains:[e.BACKSLASH_ESCAPE],variants:[{begin:"'''",
end:"'''",relevance:10},{begin:'"""',end:'"""',relevance:10},{begin:'"',end:'"'
},{begin:"'",end:"'"}]},o={begin:/\[/,end:/\]/,contains:[a,i,r,s,t,"self"],
relevance:0},c=n.either(/[A-Za-z0-9_-]+/,/"(\\"|[^"])*"/,/'[^']*'/);return{
name:"TOML, also INI",aliases:["toml"],case_insensitive:!0,illegal:/\S/,
contains:[a,{className:"section",begin:/\[+/,end:/\]+/},{
begin:n.concat(c,"(\\s*\\.\\s*",c,")*",n.lookahead(/\s*=\s*[^#\s]/)),
className:"attr",starts:{end:/$/,contains:[a,o,i,r,s,t]}}]}},
grmr_properties:e=>{const n="[ \\t\\f]*",t="([^\\\\:= \\t\\f\\n]|\\\\.)+"
;return{name:".properties",disableAutodetect:!0,case_insensitive:!0,
illegal:/\S/,contains:[e.COMMENT("^\\s*[!#]","$"),{returnBegin:!0,variants:[{
begin:t+"[ \\t\\f]*[:=][ \\t\\f]*"},{begin:t+"[ \\t\\f]+"}],contains:[{
className:"attr",begin:t,endsParent:!0}],starts:{
end:"([ \\t\\f]*[:=][ \\t\\f]*|[ \\t\\f]+)",relevance:0,starts:{
className:"string",end:/$/,relevance:0,contains:[{begin:"\\\\\\\\"},{
begin:"\\\\\\n"}]}}},{className:"attr",begin:t+n+"$"}]}},grmr_brainfuck:e=>{
const n={className:"literal",begin:/[+-]+/,relevance:0};return{name:"Brainfuck",
aliases:["bf"],
contains:[e.COMMENT(/[^\[\]\.,\+\-<> \r\n]/,/[\[\]\.,\+\-<> \r\n]/,{contains:[{
...
grmr_clojure:e=>{
const n="a-zA-Z_\\-!.?+*=<>&'",t="[#]?["+n+"]["+n+"0-9/;:$#]*",a="def defonce defprotocol defstruct defmulti defmethod defn- defn defmacro deftype defrecord",r={
$pattern:t,
...
},i={begin:t,relevance:0},s={scope:"number",relevance:0,variants:[{
...
begin:"[:]{1,2}"+t},p={begin:"\\(",end:"\\)"},_={endsWithParent:!0,relevance:0
},h={keywords:r,className:"name",begin:t,relevance:0,starts:_
},f=[d,p,o,c,l,g,m,b,s,u,i],E={beginKeywords:a,keywords:{$pattern:t,keyword:a},
end:'(\\[|#|\\d|"|:|\\{|\\)|\\(|$)',contains:[{className:"title",begin:t,
relevance:0,excludeEnd:!0,endsParent:!0}].concat(f)}
;return p.contains=[E,h,_],_.contains=f,b.contains=f,{name:"Clojure",
...
className:"number",begin:"\\b\\d+",relevance:0},n]}},grmr_groovy:e=>{
const n=e.regex,t="[A-Za-z0-9_$]+",a=ve([e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,e.COMMENT("/\\*\\*","\\*/",{
relevance:0,contains:[{begin:/\w+@/,relevance:0},{className:"doctag",
begin:"@[A-Za-z]+"}]})]),r={className:"regexp",begin:/~?\/[^\/\n]+\//,
contains:[e.BACKSLASH_ESCAPE]
},i=ve([e.BINARY_NUMBER_MODE,e.C_NUMBER_MODE]),s=ve([{begin:/"""/,end:/"""/},{
...
contains:[t,a,{className:"variable",begin:/\$[A-z]/,end:/[^A-z]/}]},i={
...
},g=[d,s,t,e.NUMBER_MODE,r,i,{className:"built_in",variants:[{
...
relevance:0})};return d.contains.unshift(u),{name:"PowerShell",
...
;const Ne=te;for(const e of Object.keys(we)){
const n=e.replace("grmr_","").replace("_","-");Ne.registerLanguage(n,we[e])}
return Ne}()
